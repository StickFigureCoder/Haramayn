...
export class RequestsService {
  ...
  getSlidesList() {
    ...
    return this.http.get<ProductListResponse<ProductImageAndTitleResponse>>(final_url);
  }
  ...
  getOurproductsList() {
    ...
    return this.http.get<ProductListResponse<ProductImageAndTitleAndPriceResponse>>(final_url)
